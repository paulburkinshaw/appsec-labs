...
## Goal
Show how relying on an unmaintained dependency creates risk, then replace it with a maintained alternative + add automated checks.

## CWE Mapping
The following CWEs are relevant to this lab:

- CWE-1104: Use of Unmaintained Third Party Components
- CWE-1395: Dependency on Vulnerable Third-Party Component
- CWE-1329: Reliance on Component That is Not Updateable
- CWE-1035: Using Components with Known Vulnerabilities (OWASP 2017 A9)
...
- [Vulnerable Third-Party Dependency](#vulnerable-third-party-dependency)
  - [Goal](#goal)
...
cd appsec-labs/owasp-top-10-2025/a03-software-supply-chain-failures/vulnerable-third-party-dependency
...
1. The app must not rely on unmaintained third-party components for security-critical functionality.
2. Dependencies should be actively maintained and have a reasonable update path.
3. Dependency health should be regularly checked (outdated + vulnerable + transitive).
...
### Links
- [OWASP Top 10 link](https://owasp.org/Top10/A08_2025-Software_and_Data_Integrity_Failures/)
